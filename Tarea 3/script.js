function generatePassword() {
    ...
    if (isNaN(longitud) || longitud < 8) {
        alert("La longitud de la contrasenia debe ser al menos 8 caracteres.");
        return;
    }
    ...
    document.getElementById("password").innerText = contrasenia;
}
...
function findTheOldest() {
    ...
    document.getElementById("oldest").innerText = oldest.nombre;
}
